...
function Router(props) {
  ...
  (0, import_react.useEffect)(() => {
    const unlisten = history.listen((location2) => {
      setLocation(location2.location);
    });
    return () => {
      unlisten && unlisten();
    };
...
var createNamedContext = function createNamedContext2(name) {
  var context2 = (0, import_create_react_context.default)();
  context2.Provider.displayName = name + ".Provider";
  context2.Consumer.displayName = name + ".Consumer";
  return context2;
};
...
var MemoryRouter = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    return import_react2.default.createElement(Router2, {
...
var StaticRouter = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.navigateTo = function navigateTo(location, action) {
    var _this$props = this.props, _this$props$basename = _this$props.basename, basename = _this$props$basename === void 0 ? "" : _this$props$basename, context2 = _this$props.context;
  ...
  _proto.render = function render() {
    ...
    return import_react2.default.createElement(Router2, _extends({}, rest, {
      history,
...
function Route2(props) {
  const context2 = (0, import_react3.useContext)(RouterContext);
  const location = props.location || context2.location;
  const match = props.computedMatch ? props.computedMatch : props.path ? matchPath(location.pathname, props) : context2.match;
  const newRouterProps = __spreadProps(__spreadValues({}, context2), { location, match });
  let { children, component } = props;
  if (Array.isArray(children) && children.length === 0)
    children = null;
  let renderChildren = import_react3.default.createElement(component, newRouterProps);
  return /* @__PURE__ */ import_react3.default.createElement(RouterContext.Provider, {
    value: newRouterProps
  }, renderChildren);
}
var Route_default = Route2;

// src/components/router/Switch.jsx
init_react_shim();
var import_react4 = __toModule(require_react());
function Switch2(props) {
  const context2 = (0, import_react4.useContext)(RouterContext);
  const location = props.location || context2.location.pathname || context2.location.location.pathname;
  let Child = null;
  import_react4.default.Children.forEach(props.children, (child) => {
    const pathname = matchPath(location, __spreadValues({}, child.props));
    if (pathname) {
      Child = import_react4.default.cloneElement(child, __spreadProps(__spreadValues({}, context2), { key: child.props.path }));
    }
  });
  return Child;
}

// src/components/router/useListen.jsx
init_react_shim();
...
// src/components/router/useLocation.jsx
init_react_shim();
var import_react6 = __toModule(require_react());
function useLocation() {
  return (0, import_react6.useContext)(RouterContext).location;
}
var useLocation_default = useLocation;

// src/components/router/useHistory.jsx
init_react_shim();
var import_react7 = __toModule(require_react());
function useHistory() {
  return (0, import_react7.useContext)(RouterContext).history;
}
...
function Home() {
  return /* @__PURE__ */ import_react8.default.createElement("h1", null, "Home");
}
function About() {
  return /* @__PURE__ */ import_react8.default.createElement("h1", null, "About");
}
function New() {
  return /* @__PURE__ */ import_react8.default.createElement("h1", null, "New");
}
function Top() {
  ...
  return /* @__PURE__ */ import_react8.default.createElement("div", null, menusList.map((item) => {
    return /* @__PURE__ */ import_react8.default.createElement("button", {
      key: item.path,
      onClick: () => goPush(item.path)
    }, item.name);
  }));
}
function App() {
  useListen_default((loaction) => {
    console.log(loaction);
  });
  return /* @__PURE__ */ import_react8.default.createElement("div", {
    className: "App"
  }, /* @__PURE__ */ import_react8.default.createElement(Router_default, null, /* @__PURE__ */ import_react8.default.createElement(Top, null), /* @__PURE__ */ import_react8.default.createElement(Switch2, null, /* @__PURE__ */ import_react8.default.createElement(Route_default, {
    component: Home,
    path: "/"
  }), /* @__PURE__ */ import_react8.default.createElement(Route_default, {
    component: About,
    path: "/about"
  }), /* @__PURE__ */ import_react8.default.createElement(Route_default, {
    component: New,
...
// src/index.jsx
import_react_dom.default.render(/* @__PURE__ */ import_react9.default.createElement(App_default, null), document.getElementById("root"));
/*
object-assign
(c) Sindre Sorhus
@license MIT
